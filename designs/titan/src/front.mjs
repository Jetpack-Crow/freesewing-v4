...
function titanFront({
  ...
  const crotchSeamDelta = () =>
    new Path()
      ...
      .length() -
    measurements.crossSeamFront * (1 + options.crossSeamEase)
  /*
  ...
  if (
    ...
    (options.useWaistAngleFor === 'both' || options.useWaistAngleFor === 'frontOnly')
  ) {
    ...
    points.styleWaistIn = points.crotchSeamCurveStart.shiftOutwards(
      points.styleWaistIn,
      triangleHeight
    )
