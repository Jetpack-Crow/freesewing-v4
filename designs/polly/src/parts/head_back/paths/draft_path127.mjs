function draft_path127(Path, Point, paths, points, measurements, options, utils, macro, part) {
  ...
  points.path127_p2_cp1 = new Point(60.2538, 104.0646)
  points.path127_p2_cp2 = new Point(91.6087, 135.8633)
  points.path127_p2_ep = new Point(113.7841, 150.8664)
  // c -23.8299 -12.3087 -67.7212 -19.3495 -93.4455 -18.7438
  points.path127_p3_cp1 = new Point(90.1701, 138.6913)
  points.path127_p3_cp2 = new Point(46.2788, 131.6505)
  points.path127_p3_ep = new Point(20.5545, 132.2562)
  // c -1.63459 33.746 -1.32107 52.4883 3.33086 78.1403
  points.path127_p4_cp1 = new Point(19.3654, 165.746)
  points.path127_p4_cp2 = new Point(19.6789, 184.4883)
  points.path127_p4_ep = new Point(24.3309, 210.1403)
  // c 4.47635 24.6838 11.8388 49.2658 23.402 71.5283
  points.path127_p5_cp1 = new Point(28.4763, 234.6838)
  points.path127_p5_cp2 = new Point(35.8388, 259.2658)
  points.path127_p5_ep = new Point(47.402, 281.5283)
  // c 9.07378 17.4696 23.2391 36.7396 35.3585 47.3018
  points.path127_p6_cp1 = new Point(56.0738, 299.4696)
  points.path127_p6_cp2 = new Point(70.2391, 318.7396)
  points.path127_p6_ep = new Point(82.3585, 329.3018)
  // c 6.30967 -7.58899 22.0015 -11.5732 34.0531 -12.3965
  points.path127_p7_cp1 = new Point(88.3097, 321.411)
  points.path127_p7_cp2 = new Point(104.0015, 317.4268)
  points.path127_p7_ep = new Point(116.0531, 316.6035)
  // c 11.1131 -0.75925 23.4173 4.19693 32.6639 7.05415
  points.path127_p8_cp1 = new Point(127.1131, 316.2407)
  points.path127_p8_cp2 = new Point(139.4173, 321.1969)
  points.path127_p8_ep = new Point(148.6639, 324.0541)
  // c 6.11959 -11.0503 26.169 -50.5519 31.4624 -78.1213
  points.path127_p9_cp1 = new Point(155.1196, 312.9497)
  points.path127_p9_cp2 = new Point(175.169, 273.4481)
  points.path127_p9_ep = new Point(180.4624, 245.8787)
  // c 9.49224 -49.4383 8.31825 -101.464 -0.52509 -151.023
  points.path127_p10_cp1 = new Point(189.4922, 196.5617)
  ...
  points.path127_p12_ep = new Point(43.4626, 83.938)
  // Z
  ...
  paths.path127 = new Path()
    ...
    .curve(points.path127_p2_cp1, points.path127_p2_cp2, points.path127_p2_ep)
    // inkex.paths.curve: c -23.8299 -12.3087 -67.7212 -19.3495 -93.4455 -18.7438
    .curve(points.path127_p3_cp1, points.path127_p3_cp2, points.path127_p3_ep)
    // inkex.paths.curve: c -1.63459 33.746 -1.32107 52.4883 3.33086 78.1403
    .curve(points.path127_p4_cp1, points.path127_p4_cp2, points.path127_p4_ep)
    // inkex.paths.curve: c 4.47635 24.6838 11.8388 49.2658 23.402 71.5283
    .curve(points.path127_p5_cp1, points.path127_p5_cp2, points.path127_p5_ep)
    // inkex.paths.curve: c 9.07378 17.4696 23.2391 36.7396 35.3585 47.3018
    .curve(points.path127_p6_cp1, points.path127_p6_cp2, points.path127_p6_ep)
    // inkex.paths.curve: c 6.30967 -7.58899 22.0015 -11.5732 34.0531 -12.3965
    .curve(points.path127_p7_cp1, points.path127_p7_cp2, points.path127_p7_ep)
    // inkex.paths.curve: c 11.1131 -0.75925 23.4173 4.19693 32.6639 7.05415
    .curve(points.path127_p8_cp1, points.path127_p8_cp2, points.path127_p8_ep)
    // inkex.paths.curve: c 6.11959 -11.0503 26.169 -50.5519 31.4624 -78.1213
    .curve(points.path127_p9_cp1, points.path127_p9_cp2, points.path127_p9_ep)
