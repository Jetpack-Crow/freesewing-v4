...
function draftPollyAnthroLegOuter({
  ...
  paths.thighCurveMiddle = new Path()
    .move(points.backDartInner_ep)
    .curve(points.frontDartOuter_cp1, points.frontDartOuter_cp2, points.frontDartOuter_ep)

  paths.thighCurveFront = new Path().move(points.frontDartInner_ep).line(points.thighFront_ep)

  const outerThighCurveLength =
