...
- Fold one of the neck tie pieces in half lengthwise, good sides and raw edges together.
...
- With _good sides together_, sew one main neck tie to one lining neck tie leaving one of the short edges open.
- Trim the seam allowances and clip the corners.
...
:::note
The notched edge of the cup is the front seam. When sewn, it is the edge that should be closest to the centre front of your body.
:::
...
- With the neck tie sandwiched inside, pin a lining cup piece _good sides together_ to the main cup piece.
...
- With _good sides together_, sew the lining to the main fabric along the bottom, leaving a gap between the side notches making sure to reinforce the stitch at the either end.
...
- Find the midpoint of the band piece, this is marked by a notch, then pin the gathered bottoms of cups to band piece, _good sides together_. You'll want the cups to meet at the band's midpoint.
...
- Fold the band tie piece in half lengthwise, good sides and raw edges together.
- Sew along the raw edges, leaving one of the short ends open.
- Trim the seam allowances and clip the corners.
- Turn inside out. Press.
...
- With _good sides together_, sew the main band tie to the lining band tie leaving one of the short edges open.
- Trim the seam allowances and clip the corners.
- Turn inside out. Press.
