---
title: 'Sabrina sports top: Sewing Instructions'
...
The first method of constructing the top requires you to use knit binding or fold-over-elastics to finish
...
Michele Nel @ Hesketh Emporium has created an in-depth video tutorial
([part 1](https://www.youtube.com/watch?v=p7lFn6kFRo8), [part 2](https://www.youtube.com/watch?v=VfXjadQELpc))
on how to prepare and sew a Sabrina top with fold-over-elastics.

Just be aware that you should enable or manually add seam-allowance (which the video skips over)
and that they skip adding the elastic inside the waistband.

[This awesome YouTube video](https://www.youtube.com/watch?v=XB0vkrKxWZk)
by Kim Dave follows constructs a similar top with the knit binding method and was used as inspiration
when developing the Sabrina design. This video also shows the intended way of constructing the waistband.
...
Again, we're using additional side pieces for a better fit across the body, so join the sides to the
fronts first, and then follow their steps.
...
Fold the fabric strip to the inside of the top and topstitch from the outside to secure the inside.
...
In this case, you may prefer using a wider waistband and reduce the length of the long side (reducing the circumference),
so your main fabric itself will give you sufficient compression.
:::
