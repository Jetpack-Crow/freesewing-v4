...
stretch the Under Collar slightly while sewing. Clip the corners, grade seams, and pull
inside out.

Press the pocket flap and top stitch _a single row_ along the sides and bottom. **_Note that
